...
import { setUser } from '../../../redux/Slices/Dashboard/User/userInfo';
...
export const Login: React.FC = () => {
  ...
  useEffect(() => {
    if (loginState.isSuccess) {
      const { givenName, username, isAdmin, id, isPaid, token } = loginState.data.result;
      dispatch(setUser({ givenName, id, username, isAdmin, token, isPaid }));
            ...
            <Form>
              ...
              <Box sx={{ mt: 2, textAlign: 'center' }}>
                <Typography variant="body2" color="text.secondary">
                  ...
                  <Link className='bg-blue-300 p-2 text-white rounded' to="/register" style={{ color: 'Highlight' }}>
                    Sign up
                  </Link>
                </Typography>
              </Box>
