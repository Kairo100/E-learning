        ...
        <Table>
          ...
          <TableBody>
            {filteredUsers.map((mapoflinecource) => (
              <TableRow className='border' key={mapoflinecource.Name}>
                <TableCell className='py-4 px-3'>{mapoflinecource.id}</TableCell>
                <TableCell className='py-4 px-3'>{mapoflinecource.Name}</TableCell>
                ...
                <TableCell className='actionsofusers'>
                  <button className='edituserlist'>
                    <Link to={`update/${mapoflinecource.id}`}>Edit</Link>
                  </button>
                  <button
                    className='deleteuserlist'
                    onClick={() => handledelete(mapoflinecource.id)}
                  >
                    Delete
                  </button>
                </TableCell>
