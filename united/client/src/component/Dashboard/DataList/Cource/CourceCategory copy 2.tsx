...
const Courcesandcategory: React.FC = () => {
  ...
  const renderCourses = (category: Category) => {
    ...
    if (filteredCourses.length > 0) {
      return (
        <div key={category.catId} className="mb-8 mt-10">
          <h2 className="text-2xl font-semibold text-cyan-600 mb-4">{category.catName}</h2>
...
export default Courcesandcategory;