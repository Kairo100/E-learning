...
const AllCourceList: React.FC = () => {
  ...
  const renderCourses = (category: Category) => {
    ...
    //                     <p className='text-gray-400 p-2' style={{textTransform:'capitalize'}}>United college</p>
  ...
  return (
    <div className="container-fluid  bg-white cours">
      <div className="container mx-auto px-4 py-8">
        ...
        {categories.length === 0 ? (
          <p className='text-center ' style={{fontWeight:"bolder"}}>No Cources found.</p>
        ) : (
