...
import { GetallcourceTeacherslice } from './Slices/Dashboard/TeacherDashboard/Getallteachercources';
  ...
  reducer: {
   ...
   //contact
    ...
    getAllCategory: getAllCategorySlice.reducer,
     ...
     //teacherCource
     getallteacherCource:GetallcourceTeacherslice.reducer,
     //contact
     getAllContact:getAllContactSlice.reducer,
     //section
     getallsetion:getallsetionSlice.reducer,
     //OflineCategory
