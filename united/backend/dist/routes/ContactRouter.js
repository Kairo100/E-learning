...
ContactRouter.get('/get/all', jwt_1.decodeToken, CantactCantroller_1.getallcontact);
...
ContactRouter.delete('/delete/:id', jwt_1.decodeToken, CantactCantroller_1.deletecontact);
